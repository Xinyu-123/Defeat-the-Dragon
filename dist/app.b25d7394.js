...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../scripts/Weapons.js":[function(require,module,exports) {
"use strict";
...
var Weapon = /*#__PURE__*/function () {
  ...
  _createClass(Weapon, [{
    key: "getWeaponAttack",
    value: function getWeaponAttack(name) {
      return 1;
    }
  }, {
    key: "getWeaponClass",
...
},{}],"../scripts/Character.js":[function(require,module,exports) {
"use strict";
...
var _default = Player;
exports.default = _default;
},{"./Character":"../scripts/Character.js","./Weapons":"../scripts/Weapons.js"}],"../node_modules/babel-register/lib/browser.js":[function(require,module,exports) {
"use strict";
...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
module.exports = {
  stoke_flame: function stoke_flame() {
...
var first_flame = function first_flame() {
...
},{"babel-core/register":"../node_modules/babel-core/register.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../scripts/Button.js":[function(require,module,exports) {
"use strict";
...
var Button = function Button(id, text, click, cooldown, width) {
  var _this = this;
  ...
  var el = $('<div>').attr('id', this._id).attr('type', 'button').text(this._text).addClass('button').css('opacity', '0').click(function () {
    ...
    getBtnFunction(_this._id);
  }).data('cooldown', this._cooldown).data('remaining', 0);
...
function startcooldown(_x, _x2) {
  return _startcooldown.apply(this, arguments);
...
function _startcooldown() {
  _startcooldown = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(btn, option) {
    var cd, id, start, left, time;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cd = btn[0]._cooldown;
            id = 'cooldown.' + btn.attr('id');
            start = cd, left = 1; // if(cd > 0){
            //     switch(option){
            ...
            $('div.cooldown').width(left * 100 + "%").animate({
              ...
              $('#' + btn[0]._id).attr('class', 'button'); // clearCooldown(btn, true);
            });
            btn[0]._disabled = true; // btn.data('onCooldown', true);
...
var _default = Button;
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js","./app":"../scripts/app.js","./Player":"../scripts/Player.js"}],"../scripts/transition.js":[function(require,module,exports) {
"use strict";
...
var Fade = /*#__PURE__*/function (_Highway$Transition) {
  ...
  _createClass(Fade, [{
    ...
    value: function _in(_ref) {
      ...
      var tl = new _gsap.TimelineLite(); // tl.fromTo(to, 3, {top: '100vh'}, {top: '0vh'})
      ...
      tl.fromTo(to, 2, {
        ...
        onComplete: function onComplete() {
          ...
          }, 1400); //Replace all of this by calling a new module that will create the game state

          setTimeout(function () {
            var stoke_btn = new _Button.default('stoke-fire', 'stoke fire', 0, 1).appendTo('div#intro-btn');
            (0, _jquery.default)(stoke_btn).animate({
              opacity: 0.5
            }, 1);
            Noti.stoke_flame();
          }, 4000);
...
var _default = Fade;
exports.default = _default;
},{"@dogstudio/highway":"../node_modules/@dogstudio/highway/build/highway.module.js","gsap":"../node_modules/gsap/index.js","./Player":"../scripts/Player.js","./notification":"../scripts/notification.js","./Button":"../scripts/Button.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../scripts/app.js":[function(require,module,exports) {
"use strict";
...
exports.stoke_fire = exports.player = void 0;
...
var character_form = document.getElementById('character-select');
var STOKE_COOLDOWN = 2;
var player;
exports.player = player;
start_btn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var character_class, type;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          character_class = getCharacterVal(character_form, 'class');
          _context.next = 3;
...
var stoke_fire = function stoke_fire() {
  document.getElementById('stoke-fire').addEventListener('click', function () {
    document.getElementsByClassName('wrapper')[0].style.display = 'block';
  });
};

exports.stoke_fire = stoke_fire;
...
displaySubmit();
},{"@dogstudio/highway":"../node_modules/@dogstudio/highway/build/highway.module.js","./transition":"../scripts/transition.js","./Character":"../scripts/Character.js","./Player":"../scripts/Player.js","./Button":"../scripts/Button.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.b25d7394.js.map