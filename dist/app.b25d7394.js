...
var page = _interopRequireWildcard(require("./gamepage"));
...
var Game = _interopRequireWildcard(require("./gamepage"));
    ...
    value: function _in(_ref) {
      ...
      tl.fromTo(to, 2, {
        ...
        onComplete: function onComplete() {
          from.remove();
          var grad = (0, _jquery.default)('<div>').addClass('text-gradient');
          (0, _jquery.default)('.text-container').append(grad);
          Game.setUpGame();
          done();
        }
      });
...
start_btn.addEventListener('click', function () {
  var character_class = getCharacterVal(character_form, 'class');
  var type = character_class; // console.log({type});
